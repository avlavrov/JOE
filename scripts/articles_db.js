export const articleDatabase = [
    ...
    articleRevisions: [
      {
        ...
        ratingByAuthor: '',
        categories: [],//different categories from catalogue
        keyWords: [], //different keywords
        conflictDisclosure: '',
        authorsInput: '',
        ethicStatement: '',
        status: '', //Submitting, Submitted , OnReview, Waiting Author's Reply, Accepted, Published, Denied, Revoked
        lastStatusDateTime: '',
        likeCount: '',
      },
  ...
  {//start of article
    articleID: 2, // = of massive element
    lastRevisionN: 0,
    articleRevisions: [
      {
        articleRevisionID: 2.0,
        submitDate: '',
        reviewID: '',
        authors: 'Svetlana A Smirnikhina 1, Arina A Anuchina 2, Alexander V Lavrov 2 3',//author
        affiliations: '1Laboratory of Mutagenesis, Federal State Budgetary Institution "Research Centre        for Medical Genetics", Moskvorechie, 1, Moscow, 115522, Russia. smirnikhinas@gmail.com.         2Laboratory of Mutagenesis, Federal State Budgetary Institution `Research Centre for Medical Genetics`,         Moskvorechie, 1, Moscow, 115522, Russia.         3Department of Molecular and Cellular Genetics, The Russian National Research Medical University Named         after         N.I. Pirogov, Moscow, Russia.',
        type: 'Review',
        publicationDateTime: '08 February 2020',
        preImageLink: 'https://pictures.s3.yandex.net/frontend-developer/free-course/card-2.jpg',
        articleTitle: 'Ways of improving precise knock-in by genome-editing technologies',
  ...
  {//start of article
  articleID: 3, // = of massive element
  lastRevisionN: 0,
  articleRevisions: [
    {
      articleRevisionID: 3.0,
      submitDate: '',
      reviewID: '',
      authors: 'Alexander V Lavrov 1, Georgi G Varenikov 2, Mikhail Yu Skoblov 3 2 4',//author
      affiliations: '1Research Center for Medical Genetics, Moscow, Russia.       alexandervlavrov@gmail.com.       2Moscow Institute of Physics and Technology, Dolgoprudny, Russia.   3Research Center for Medical Genetics, Moscow, Russia.       4School of Biomedicine, Far Eastern Federal University, Vladivostok, Russia.',
      type: 'Review',
      publicationDateTime: '08 February 2020',
      preImageLink: 'https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs12920-020-00735-8/MediaObjects/12920_2020_735_Fig3_HTML.png',
      articleTitle: 'Genome scale analysis of pathogenic variants targetable for single base editing',
...
{//start of article
  articleID: 4, // = of massive element
  lastRevisionN: 0,
  articleRevisions: [
    {
      articleRevisionID: 4.0,
      submitDate: '',
      reviewID: '',
      authors: 'Anna Middleton, Richard Milne, Mohamed A.Almarri, Shamim Anwer, Jerome Atutornu,      Elena      E.Baranova, Paul Bevan, Maria Cerezo, Yali Cong, Christine Critchley, Josepine Fernow, Peter Goodhand,      Qurratulain Hasan, Aiko Hibino, Gry Houeland, Heidi C.Howard, S. Zakir Hussain, Charlotta Ingvoldstad      Malmgren, Vera .Izhevskaya, Aleksandra Jędrzejak, Cao Jinhong, Megumi Kimura, Erika Kleiderman, Brandi      Leach,      Keying Liu, Deborah Mascalzoni, Álvaro Mendes, Jusaku Minari, Nan Wang, Dianne Nicol, Emilia Niemiec,      Christine Patch, Jack Pollard, Barbara Prainsack, Marie Rivière, Lauren Robarts, Jonathan Roberts,      Virginia      Romano, Haytham A.Sheerah, James Smith, Alexandra Soulier, Claire Steed, Vigdís Stefànsdóttir, Cornelia      Tandre, Adrian Thorogood, Torsten H.Voigt, Anne V.West, Go Yoshizawa, Katherine I.Morley.3',//author
      affiliations: 'Middleton et al., Global Public Perceptions of Genomic Data Sharing: What      Shapes      the Willingness to Donate DNA and Health Data? The American Journal of Human Genetics (2020).',
      type: 'Review',
      publicationDateTime: '08 February 2020',
      preImageLink: 'https://els-jbs-prod-cdn.jbs.elsevierhealth.com/cms/attachment/0c134010-5183-4f6a-8a39-c26275f37649/gr6.jpg',
      articleTitle: 'Global Public Perceptions of Genomic Data Sharing: What Shapes the Willingness to       Donate      DNA and Health Data?',
...
{//start of article
  articleID: 5, // = of massive element
  lastRevisionN: 0,
  articleRevisions: [
    {
      articleRevisionID: '5.0',
      submitDate: '',
      reviewID: '',
      authors: 'Kondrateva E, Adilgereeva E, Amelina E, Tabakov V, Demchenko A, Ustinov K,      Yasinovsky      M, Voronina E, Lavrov A, Smirnikhina S.',//author
      affiliations: 'Research Centre for Medical Genetics, Moscow 115522, Russian Federation  b      The Research Institute of Pulmonology, Moscow 115682, Russian Federation',
      type: 'Review',
      publicationDateTime: '08 February 2020',
      preImageLink: 'https://ars.els-cdn.com/content/image/1-s2.0-S1873506120302348-gr1.jpg',
      articleTitle: 'Generation of induced pluripotent stem cell line (RCMGi001-A) from human skin fibroblasts of a cystic fibrosis patient with p.F508del mutation',
      abstract: 'Skin fibroblasts obtained from a 27-year-old man with clinically manifested and       genetically proven (F508del/F508del) cystic fibrosis were successfully transformed into induced      pluripotent      stem cells (iPSCs) by using Sendai virus-based reprogramming vectors including the four Yamanaka factors,      OCT3/4, SOX2, KLF4, and c-MYC. The iPSCs showed a normal karyotype, expressed pluripotency markers and      exhibited the potential to differentiate into three germ layers in spontaneous differentiation assay. This      iPSC line may be subsequently used for development of a personalized etiotropic treatment including genome      editing, and for disease modelling and drug screening.',
      fullText: '',
      fullLink: '5.0.html',
      winDocID: '',
      pdfID: '',
...
{//start of article
  articleID: 6, // = of massive element
  lastRevisionN: 0,
  articleRevisions: [
    {
      articleRevisionID: '6.0',
      submitDate: '',
      reviewID: '',
...
//Article template
const article = {//start of article
  articleID: '',
  lastRevisionN: '',
  articleRevisions: [
    {//start of revision
